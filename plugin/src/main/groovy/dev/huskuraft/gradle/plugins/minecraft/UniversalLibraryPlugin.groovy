...
import dev.huskuraft.gradle.plugins.minecraft.versioning.VersionResolver
...
class UniversalLibraryPlugin implements Plugin<Project> {
    void apply(Project project) {
        ...
        project.shadowJar {
            ...
            relocate 'dev.huskuraft.universal.vanilla', 'dev.huskuraft.universal.fabric'
